...
## Methods
**Physical activity and sleep.** Fitbits were given to 30 participants and their physical activity levels and sleep durations across ???? timepoints. For this study, we compared the physical activity levels (sedentary, lightly active, fairly active, and very active) against the total sleep duration data gathered from the fitbits.

**Stress level and sleep.** Three hundred and seventy-four participants were 
